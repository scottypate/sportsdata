...
class DefaultApi(object):
    ...
    def event_with_http_info(self, format, eventid, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='MmaStatsEventDetail',  # noqa: E501
    ...
    def fight(self, format, fightid, **kwargs):  # noqa: E501
        """Fight  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.fight(format, fightid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str format: Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>. (required)
        :param str fightid: The unique ID of this fight. <br> Examples: <code>1100</code>, etc. (required)
        :return: MmaStatsFightDetail
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.fight_with_http_info(format, fightid, **kwargs)  # noqa: E501
        else:
            (data) = self.fight_with_http_info(format, fightid, **kwargs)  # noqa: E501
            return data

    def fight_with_http_info(self, format, fightid, **kwargs):  # noqa: E501
        """Fight  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.fight_with_http_info(format, fightid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['format', 'fightid']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('format' not in params or
                params['format'] is None):
            raise ValueError("Missing the required parameter `format` when calling `fight`")  # noqa: E501
        # verify the required parameter 'fightid' is set
        if ('fightid' not in params or
                params['fightid'] is None):
            raise ValueError("Missing the required parameter `fightid` when calling `fight`")  # noqa: E501
        ...
        if 'format' in params:
            path_params['format'] = params['format']  # noqa: E501
        if 'fightid' in params:
            path_params['fightid'] = params['fightid']  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='MmaStatsFightDetail',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def fighter_with_http_info(self, format, fighterid, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='MmaStatsFighter',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def fighters_with_http_info(self, format, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[MmaStatsFighter]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def leagues_with_http_info(self, format, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[MmaStatsLeague]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def schedule_with_http_info(self, format, league, season, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[MmaStatsEvent]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
