...
from sportsdata.nhl_projections.api_client import ApiClient
...
class DefaultApi(object):
    ...
    def dfs_slates_by_date(self, format, _date, **kwargs):  # noqa: E501
        ...
        :return: list[NhlProjectionsDfsSlate]
    ...
    def dfs_slates_by_date_with_http_info(self, format, _date, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='list[NhlProjectionsDfsSlate]',  # noqa: E501
    ...
    def projected_player_game_stats_by_date_w_injuries_dfs_salaries(self, format, _date, **kwargs):  # noqa: E501
        ...
        :return: list[NhlProjectionsPlayerGameProjection]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def projected_player_game_stats_by_date_w_injuries_dfs_salaries_with_http_info(self, format, _date, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[NhlProjectionsPlayerGameProjection]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def projected_player_game_stats_by_player_w_injuries_dfs_salaries(self, format, _date, playerid, **kwargs):  # noqa: E501
        ...
        :return: NhlProjectionsPlayerGameProjection
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def projected_player_game_stats_by_player_w_injuries_dfs_salaries_with_http_info(self, format, _date, playerid, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='NhlProjectionsPlayerGameProjection',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def starting_goaltenders_by_date(self, format, _date, **kwargs):  # noqa: E501
        """Starting Goaltenders by Date  # noqa: E501

        This endpoint provides the projected & confirmed starting goaltenders for NHL games on a given date.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.starting_goaltenders_by_date(format, _date, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str format: Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>. (required)
        :param str _date: The date of the game(s). <br>Examples: <code>2021-OCT-12</code>, <code>2021-DEC-09</code>. (required)
        :return: list[NhlProjectionsStartingGoaltenders]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.starting_goaltenders_by_date_with_http_info(format, _date, **kwargs)  # noqa: E501
        else:
            (data) = self.starting_goaltenders_by_date_with_http_info(format, _date, **kwargs)  # noqa: E501
            return data

    def starting_goaltenders_by_date_with_http_info(self, format, _date, **kwargs):  # noqa: E501
        """Starting Goaltenders by Date  # noqa: E501

        This endpoint provides the projected & confirmed starting goaltenders for NHL games on a given date.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.starting_goaltenders_by_date_with_http_info(format, _date, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method starting_goaltenders_by_date" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'format' is set
        if ('format' not in params or
                params['format'] is None):
            raise ValueError("Missing the required parameter `format` when calling `starting_goaltenders_by_date`")  # noqa: E501
        # verify the required parameter '_date' is set
        if ('_date' not in params or
                params['_date'] is None):
            raise ValueError("Missing the required parameter `_date` when calling `starting_goaltenders_by_date`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[NhlProjectionsStartingGoaltenders]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
