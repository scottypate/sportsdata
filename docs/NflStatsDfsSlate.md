...
**dfs_slate_games** | [**list[NflStatsDfsSlateGame]**](NflStatsDfsSlateGame.md) |  | [optional] 
**dfs_slate_players** | [**list[NflStatsDfsSlatePlayer]**](NflStatsDfsSlatePlayer.md) |  | [optional] 
