...
**dfs_slate_games** | [**list[NhlStatsDfsSlateGame]**](NhlStatsDfsSlateGame.md) |  | [optional] 
**dfs_slate_players** | [**list[NhlStatsDfsSlatePlayer]**](NhlStatsDfsSlatePlayer.md) |  | [optional] 
