...
**dfs_slate_games** | [**list[NbaStatsDfsSlateGame]**](NbaStatsDfsSlateGame.md) |  | [optional] 
**dfs_slate_players** | [**list[NbaStatsDfsSlatePlayer]**](NbaStatsDfsSlatePlayer.md) |  | [optional] 
